function VirtualGuitarExample
%VirtualGuitarExample   Launches the virtual guitar example.
%   This example shows how to specify chords on a virtual guitar fretboard
%   and synthesize them using discrete-time filters.
%
% See also GUITARFILTEREXAMPLE
...
uimenu(render_spthelpmenu(hfig, 4), ...
    'Position', 3, ...
...
h.info = uicontrol(hfig, ...
    ...
    'BackgroundColor', 'w', ...
    'HorizontalAlignment', 'Left', ...
    'String', sprintf('%s%s%s%s%s', 'The virtual guitar example shows how to ', ...
        'simulate the strumming of a guitar by using discrete-time ', ...
        'filters.  The magnitude plot shows how each ', ...
        'filter has peaks at the harmonics for the string it is meant to represent.  ', ...
        'For more information run ''playshow GuitarFilterExample''.'), ...
